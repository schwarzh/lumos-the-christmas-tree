...
public class strip50_love extends PApplet {
...
public void setup()
{
  ...
  // Load a sample image
  im = loadImage("heart.jpg");

  // Connect to the local instance of fcserver
  opc = new OPC(this, "127.0.0.1", 7890);

  // Map one 50-LED strip to the center of the window
  opc.ledStrip(0, 50, width/2, height/2, width / 55.0f, 0, false);
}
...
public class OPC implements Runnable
{
  ...
  // Set the location of 50 LEDs arranged in a uniform 8x8 grid.
  // (x,y) is the center of the grid.
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "strip50_love" };
    if (passedArgs != null) {
